...
async function askMentor() {
    ...
    try {
        const response = await fetch("http://localhost:5050/ask-ai", {
...
async function getRecommendations() {
    ...
    try {
        const response = await fetch("http://localhost:5050/get-recommendation", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function askHelpdeskAI() {
    ...
    try {
        const response = await fetch("http://localhost:5050/ask-helpdesk", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
